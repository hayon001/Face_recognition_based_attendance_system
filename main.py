...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'ritabratabanerjee9@gmail.com' ")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='Some file missing', message='Please enter file first')
        window.destroy()
...
def TrackImages():
    ...
    if exists1:
        ...
        mess._show(title='Details Missing', message='Details are missing, please check!')
        cam.release()
        cv2.destroyAllWindows()
        window.destroy()
    while True:
...
message3 = tk.Label(window, text="Attendance System using face recognition" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
